 ...
 * department / a whole UC / a whole NA / several NAs / everyone) into a
 * concrete list of user IDs *once*, at creation time — matching how Phase 3
 * already resolves "select all volunteers" for daily-report meetings,
 * rather than dynamically re-evaluating membership on every read (so
 * someone joining a department later doesn't retroactively appear on an
 * older meeting/task).
 */
