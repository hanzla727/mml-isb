...
@section('content')
    <form method="GET" class="card stat-card p-3 mb-3">
        <div class="input-group">
            <input type="text" name="q" value="{{ $query }}" class="form-control" placeholder="Search contacts, tasks, reports, meetings, projects, NAs, UCs...">
