...
@section('content')
    <div class="card stat-card p-4 mb-3">
        ...
        <small class="text-muted">{{ $project->progress() }}% of tasks completed</small>
    </div>

    <div class="row g-3">
        <div class="col-md-6">
            <div class="card stat-card p-4">
                <h6 class="mb-3">Meetings ({{ $project->meetings->count() }})</h6>
                ...
                @empty
                    <p class="text-muted small mb-0">No meetings linked to this project.</p>
                @endforelse
            </div>
        </div>
        <div class="col-md-6">
            <div class="card stat-card p-4">
                <h6 class="mb-3">Tasks ({{ $project->tasks->count() }})</h6>
                ...
                @empty
                    <p class="text-muted small mb-0">No tasks linked to this project.</p>
                @endforelse
            </div>
        </div>
    </div>
