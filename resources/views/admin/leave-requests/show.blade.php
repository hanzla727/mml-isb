...
@section('content')
    <div class="card stat-card p-4" style="max-width: 640px;">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
                <h5 class="mb-1">{{ ucfirst($leaveRequest->leave_type) }} Leave</h5>
        ...
        <div class="mb-3">
            ...
            <div class="text-muted small">{{ $leaveRequest->start_date->diffInDays($leaveRequest->end_date) + 1 }} day(s)</div>
        </div>
        ...
        <a href="{{ route('admin.leave-requests.index') }}" class="btn btn-link ps-0 mt-2">&larr; Back to Leave Requests</a>
    </div>
@endsection
